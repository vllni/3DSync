...
# Install git, git-lfs, cmake, and build tools
...
# Build and install bannertool (https://github.com/carstene1ns/3ds-bannertool)
...
# Build and install makerom (https://github.com/3DSGuy/Project_CTR)
